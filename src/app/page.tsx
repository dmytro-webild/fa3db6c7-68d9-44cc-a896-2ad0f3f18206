...
export default function LandingPage() {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Proximity to Fun",
          description: "Just a short walk from Lapethos Aqua Park for family entertainment.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/colourful-plastic-slides-water-park-sunlight_1150-12378.jpg",
            imageAlt: "Aqua Park",
          },
          phoneTwo: {
        ...
        {
          title: "Beach Access",
          description: "Enjoy the Mediterranean sun, only 5km from the famous Mare Monte Beach.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/aerial-view-colorful-beach-huts-along-rye-shoreline_1308-189689.jpg",
            imageAlt: "Mare Monte Beach",
          },
          phoneTwo: {
        ...
        },
        {
          ...
          description: "Our dedicated staff ensures your stay in Lapta is nothing short of exceptional.",
          phoneOne: {
  ...
  <div id="gallery" data-section="gallery">
      ...
      products={[
        ...
        },
        {
          ...
          price: "View",
          variant: "Nature",
          imageSrc: "http://img.b2bpic.net/free-photo/autumn-hiking-trail_649448-738.jpg",
        },
        {
          id: "p5",
          name: "Grand Entrance",
      ...
      faqs={[
        {
          ...
          content: "Yes, we offer complimentary parking for our guests.",
        },
        {
          id: "f2",
          title: "Are pets allowed?",
          content: "Please contact our reception desk for our pet policy.",
        },
        {
          id: "f3",
          title: "Do you offer airport transfer?",
          content: "Yes, we can arrange airport transfers upon request.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Book Now",
          href: "http://clubalda.traveleto.com",
        },
        {
          text: "+90 392 821 87 80",
          href: "tel:+903928218780",
        },
      ]}
    />
  </div>
